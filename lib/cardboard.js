! function() {
    ...
    if ("undefined" != typeof exports ? (a = !1, "undefined" != typeof module && module.exports && (f = !0)) : a = !0, a) {
        var q = b.document.createElement("iframe");
        q.src = p.prod, q.style.display = "none", q.name = "bookstrap", b.HTML_Reporter = b.mocha._reporter, b.cardboard = function(a) {
        ...
        var r;
        d && (h = require("request"), i = require("mocha").reporters.Dot, k = require("fs")), process.exit = function(a) {
            h(r, function() {
